...
/**
 * https://www.envisioniot.com/docs/bpm-api/en/2.3.0/process/query_process_instance.html  <br>
 *
 * @author arihant.jain
 * @create 17/3/2022
 * @since --
...
public class QueryProcessInstance {
    public JSONObject queryProcessInstance(
            String accessKey,
            String secretKey,
            String url,
            String bearerToken,
       ...
       // request.setHeaderParam("Content-Type", "application/json");
        ...
        try {
            JSONObject response = Poseidon.config(PConfig.init().appKey(accessKey).appSecret(secretKey).debug())
                    .url(url + "/enos-bpm-service/v2.0/work/process-instances/queryList")
    ...
    public JSONObject queryProcessInstanceWithPagination(
            String accessKey,
            String secretKey,
            String url,
            String bearerToken,
