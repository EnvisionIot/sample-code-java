...
import com.envisioniot.example.sample.functions.connection.firmwaremanagement.*;
...
public class ConnectionFirmwareOTAupgradeManagementApp {
    public void firmwareOTAupgradeManagement(String accessKey, String secretKey, String orgId, String url){
        ...
        // 3 firmware files on enOS created. v1_2 requires verification before upgrade.
        ...
        String firmwareVersion_v1_2 = getFirmwareFile.getFirmwareFile(
                ...
                .getData()
                .getVersion();
        String firmwareVersion_v1_3_ev = getFirmwareFile.getFirmwareFile(
                accessKey, secretKey, orgId, url, firmwareId_v1_3_ev)
                .getData()
                .getVersion();
        ...
        /*
        HashSet<String> deviceToVerifySet = new HashSet<>();
        deviceToVerifySet.add(deviceInfo2.getDeviceKey());
         */
