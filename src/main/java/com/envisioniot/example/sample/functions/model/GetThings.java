...
public class GetThings {
    public void getThings(String accessKey, String secretKey, String orgId, String url) throws JsonProcessingException {
        ...
        String json = ow.writeValueAsString(response.getData());
