...
import com.envisioniot.enos.event_service.v2_1.CreateHistoryAlertRequest;
import com.envisioniot.enos.event_service.v2_1.CreateHistoryAlertResponse;
...
public class CreateHistoryAlert {
    public void createHistoryAlert(String accessKey, String secretKey, String orgId, String url) {
        ...
        GenerateHistoryAlert historyAlert = buildHistoryAlert();
    ...
    public void createHistoryAlertWithDevice(String accessKey, String secretKey, String orgId, String url) {
        CreateHistoryAlertRequest request = new CreateHistoryAlertRequest();
        request.setOrgId(orgId);
        GenerateHistoryAlert historyAlert = buildHistoryAlertWithDevice();
        request.setHistoryAlert(historyAlert);
        try {
            CreateHistoryAlertResponse response = Poseidon.config(PConfig.init().appKey(accessKey).appSecret(secretKey).debug())
                    .url(url)
