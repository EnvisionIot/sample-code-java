...
//        AssociateAssetNodeBatch associateAssetNodeBatch = new AssociateAssetNodeBatch();
//        associateAssetNodeBatch.associateAssetNodeBatch(accessKey, secretKey, orgId, url);
...
//        MoveAssetNode moveAssetNode = new MoveAssetNode();
//        moveAssetNode.moveAssetNode(accessKey, secretKey, orgId, url);
//
