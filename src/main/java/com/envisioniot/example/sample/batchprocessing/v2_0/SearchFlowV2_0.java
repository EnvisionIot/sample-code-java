...
/**
 * https://www.envisioniot.com/docs/batch-processing-api/en/2.3.0/v2.0/search_flow.html  <br>
 * @author arihant.jain
 * @create 15/3/22
 * @since --
 */

public class SearchFlowV2_0 {
    public JSONObject searchFlowV2_0(
            String accessKey,
            String secretKey,
            String orgId,
            String url,
            ...
            JSONObject pagination)
    {
        ...
        if(expression != null){request.setBodyParams("expression", expression);}
