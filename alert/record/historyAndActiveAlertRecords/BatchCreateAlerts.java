...
import com.envisioniot.enos.alert_service.v2_1.BatchCreateAlertsRequest;
import com.envisioniot.enos.alert_service.v2_1.BatchCreateAlertsResponse;
...
public class BatchCreateAlert {
    ...
    private AlertVo buildAlert(int type) {
        ...
        alertVo.setInstanceId("GW46kFBhkA");
